...
void APP_EventHandler(EVNT_Handle event) {
	...
	case EVNT_SW1_RELEASED:
		...
		SHELL_SendString("SW1 released A\r\n");
#if PL_CONFIG_HAS_LINE_FOLLOW
	...
	case EVNT_SW1_LPRESSED:
		...
		SHELL_SendString("SW2 pressed B\r\n");
#if (PL_CONFIG_CONTROL_SENDER && PL_CONFIG_HAS_REMOTE)
		val = 'B';
#endif
		break;
		...
		SHELL_SendString("SW3 pressed C\r\n");
#if (PL_CONFIG_CONTROL_SENDER && PL_CONFIG_HAS_REMOTE)
		val = 'C';
#endif
		break;
		...
		SHELL_SendString("SW4 pressed D\r\n");
#if (PL_CONFIG_CONTROL_SENDER && PL_CONFIG_HAS_REMOTE)
		val = 'D';
#endif
		break;
		...
		SHELL_SendString("SW5 pressed E\r\n");
#if (PL_CONFIG_CONTROL_SENDER && PL_CONFIG_HAS_REMOTE)
		val = 'E';
#endif
		break;
		...
		SHELL_SendString("SW6 pressed F\r\n");
#if (PL_CONFIG_CONTROL_SENDER && PL_CONFIG_HAS_REMOTE)
		val ='F';
#endif
		break;
